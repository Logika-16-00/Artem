...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listWidget.setGeometry(QtCore.QRect(0, 60, 121, 501))
        ...
        self.btn_left.setGeometry(QtCore.QRect(180, 480, 91, 61))
        self.btn_left.setObjectName("btn_left")
        self.btn_right = QtWidgets.QPushButton(self.centralwidget)
        self.btn_right.setGeometry(QtCore.QRect(320, 480, 91, 61))
        self.btn_right.setObjectName("btn_right")
        self.btn_flip = QtWidgets.QPushButton(self.centralwidget)
        self.btn_flip.setGeometry(QtCore.QRect(460, 480, 101, 61))
        self.btn_flip.setObjectName("btn_flip")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(180, 60, 681, 361))
        self.label.setObjectName("label")
        self.btn_sharp = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sharp.setGeometry(QtCore.QRect(600, 480, 111, 61))
        self.btn_sharp.setObjectName("btn_sharp")
        self.pushButton_6 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_6.setGeometry(QtCore.QRect(750, 480, 111, 61))
        self.pushButton_6.setObjectName("pushButton_6")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 952, 18))
